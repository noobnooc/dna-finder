  ...
  return showingNextLevel ? (
    <div>
      <Image
        ...
        alt="图片 1"
      />
      你可以走出阶梯神殿，来到户外大棚下，欣赏漂亮的田野与邻近的水池，休憩的同时听一下先辈们的故事：随着公社的壮大，游民之间碰撞出了精彩的火花。其中有三兄弟，他们给DNA公社引进了自助酒柜。游民们可以在这里自助购买饮料酒水，我们的第三把钥匙也在
      <span className="text-red-600 mx-2 font-bold">苕溪三兄弟招牌旁</span>
      的桌子上。
